...
export const createNewUnitModal = new InjectionToken('CreateNewUnitModal');
...
export const createNewUnitModalProvider = {
  provide: createNewUnitModal,
  useFactory: (i: any) => i.get('CreateNewUnitModal'),
  deps: ['$injector'],
};
